...
def generate_wine(quality, fixed_acidity_avg, fixed_acidity_std, volatile_acidity_avg, volatile_acidity_std, 
    ...
    if type(type_wine) != int:
        type_wine = int(type_wine)
...
def get_random_wine():
    ...
    return generate_wine(4, 7.13, 1.08, 0.38, 0.17, 0.3, 0.16, 4.63, 4.16, 0.05, 0.03, 23.36, 20.39, 125.28, 52.75, 0.99, 0.0, 3.18, 0.16, 0.48, 0.12, 10.15, 1.0, 0)
